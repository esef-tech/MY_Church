  ...
  <footer class="border-t border-neutral-800 bg-neutral-950 py-12">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <div class="text-[10px] uppercase tracking-[0.22em] text-amber-500">Kingdom Keys Prayer Chapel A/G</div>
            </div>
          </div>
      ...
      <div class="mt-8 border-t border-neutral-800 pt-6 text-center text-xs text-neutral-500">
        © 2026 KKPC A/G Kingdom Keys Prayer Chapel. All rights reserved.
      </div>
    </div>
  </footer>
</template>
